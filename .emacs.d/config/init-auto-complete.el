;;(when (or (eq dotemacs-completion-engine 'auto-complete)
...
;; enable only for erlang-mode since we use company
(setq ac-modes '(erlang-mode))
...
(after 'yasnippe        (add-hook 'yas-before-expand-snippet-hook (lambda () (auto-complete-mode -1)))
